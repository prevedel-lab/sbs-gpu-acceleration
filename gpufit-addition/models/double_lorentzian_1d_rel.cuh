#ifndef GPUFIT_DOUBLE_LORENTZIAN_1D_REL_INCLUDED
#define GPUFIT_DOUBLE_LORENTZIAN_1D_REL_INCLUDED
...
__device__ void calculate_double_lorentzian_1d_rel(
    ...
    std::size_t const user_info_size)
{
    ...
    current_derivatives[1 * n_points] = 2 * A_1 * delta_1 * gamma_squarred_1 / squarred_denominator_1
            + 2* A_2 * delta_2 * gamma_squarred_2 / squarred_denominator_2;                             // derivative x0_1
    ...
    current_derivatives[4 * n_points] = 2 * A_2 * gamma_squarred_2 * delta_2 / squarred_denominator_2;  // derivative delta
