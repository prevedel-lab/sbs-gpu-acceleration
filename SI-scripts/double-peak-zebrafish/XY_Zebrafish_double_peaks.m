...
saveastiff(volume.shift , 'tiff_export\XY_shift.tif', options);
saveastiff(volume.width , 'tiff_export\XY_width.tif', options);
saveastiff(volume.amplitude, 'tiff_export\XY_amplitude.tif', options);
saveastiff(volume.offset, 'tiff_export\XY_offset.tif', options);